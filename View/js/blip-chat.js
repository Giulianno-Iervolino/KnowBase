  ...
  return /******/ (function (modules) {
    ...
    /******/ [
            ...
            [
              ...
              },
              {
                ...
                value: function build() {
                  this.widget = new _BlipChatWidget.BlipChatWidget(
                    this.appKey,
                    this.buttonConfig,
                    this.authConfig,
                    this.account,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports =
          1 / $parseFloat(__webpack_require__(70) + "-0") !== -Infinity
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var $WeakMap = (module.exports = __webpack_require__(58)(
          WEAK_MAP,
          wrapper,
          methods,
          weak,
        ...
        /* WEBPACK VAR INJECTION */ (function (global) {
          ...
          var BlipChatWidget = (exports.BlipChatWidget = (function () {
            function BlipChatWidget(
              ...
              self.appKey = appKey;
              self.buttonColor =
                buttonConfig && buttonConfig.color
                  ? buttonConfig.color
                  : "#0096fa";
              self.buttonIcon =
                buttonConfig && buttonConfig.icon
                  ? buttonConfig.icon
                  : _brandLogo2.default;
              ...
              self.target = target;
              self.events = events;
              self.blipChatContainer =
                target || _Misc.dom.createDiv("#blip-chat-container");
              self.isOpen = false;
              ...
              self.NotificationHandler =
                new _NotificationHandler.NotificationHandler(self);
            ...
            _createClass(BlipChatWidget, [
              ...
              },
              {
                ...
                value: function _setSubscribers() {
                  ...
                  var toggleNotificationsButton =
                    function toggleNotificationsButton(count) {
                      return (document.getElementById(
                        "blip-chat-notifications"
              ...
              },
              {
                ...
                value: function _setChatUrlEnvironment(
                  environment,
                  authConfig,
                  appKey
                ) {
                  ...
                  if (authConfig)
                    self.CHAT_URL += "&authType=" + authConfig.authType;
                },
              },
              {
                key: "_resizeElements",
                value: function _resizeElements() {
                  var blipFAB = document.getElementById(
                    "blip-chat-open-iframe"
                  );
                  var blipChatIframe =
                    document.getElementById("blip-chat-iframe");
                  var screenHeight = window.outerHeight - 250;

                  blipFAB.style.height = window.getComputedStyle(blipFAB).width;
                  if (blipChatIframe) {
                    blipChatIframe.style.bottom =
                      "calc(55px + " + blipFAB.style.height + " )";
                    if (!self.target) {
                      // Chat presented on widget
              ...
              },
              {
                ...
                value: function _addAuthTypeToExtras(account, authConfig) {
                  var authType = authConfig
                    ? authConfig.authType || _BlipChat.BlipChat.GUEST_AUTH
                    : _BlipChat.BlipChat.GUEST_AUTH;
                  if (account) {
              ...
              },
              {
                ...
                value: function _parseAuthConfig(authConfig) {
                  ...
                  authConfig.userPassword = window.btoa(
                ...
                value: function _createIframe() {
                  ...
                  self.blipChatIframe.onload = function () {
                    ...
                    self._sendPostMessage({
                      code: _Constants2.default.START_CONNECTION_CODE,
              ...
              },
              {
                ...
                value: function _openChat(event, forceClose) {
                  ...
                  var blipChatCloseIcon = document.getElementById(
                    "blip-chat-close-icon"
                  );
                  var blipChatButton = document.getElementById(
                    "blip-chat-open-iframe"
                  );
                  ...
                  if (
                    !forceClose &&
                    self.blipChatIframe &&
                    !self.blipChatIframe.classList.contains(
                    ...
                    setTimeout(function () {
                      self.blipChatIframe.classList.add(
                        "blip-chat-iframe-opened"
                      );
                      self._resizeElements();
                    ...
                    self.blipChatIframe.classList.remove(
                      "blip-chat-iframe-opened"
                    );
                ...
                value: function _onReceivePostMessage(message) {
                  switch (message.data.code) {
                    ...
                    case _Constants2.default.CREATE_ACCOUNT_CODE:
                      ...
                      if (self.events.OnCreateAccount)
                        self.events.OnCreateAccount();

                      var accountObj = JSON.parse(data);
                      if (
                        accountObj.authType === _Constants2.default.GUEST_AUTH
                      ) {
                        _StorageService2.default.setToLocalStorage(
                          _Constants2.default.USER_ACCOUNT_KEY,
                          accountObj,
                          _Constants2.default.COOKIES_EXPIRATION
                        );
                      }
                      break;
                    ...
                    case _Constants2.default.CHAT_CONNECTED_CODE:
                      if (self.account)
                        self._sendPostMessage({
                          code: _Constants2.default.USER_IRIS_ACCOUNT,
              ...
              },
              {
                ...
                value: function _checkFullScreen() {
                  ...
                  if (
                    ...
                    self.isFullScreen = enteredFullScreen;
                    self._sendPostMessage({
                      code: _Constants2.default.SHOW_CLOSE_BUTTON,
              ...
              },
              {
                ...
                value: function _getObfuscatedUserAccount() {
                  if (
                    !self.authConfig ||
                    self.authConfig.authType === _Constants2.default.GUEST_AUTH
                  ) {
                    return _StorageService2.default.getFromLocalStorage(
                      _Constants2.default.USER_ACCOUNT_KEY
                    );
                  } else if (
                    self.authConfig.authType === _Constants2.default.DEV_AUTH
                  ) {
              ...
              },
              {
                ...
                value: function sendMessage(userMessage) {
                  ...
                  self._sendPostMessage({
                    code: _Constants2.default.SEND_MESSAGE_CODE,
                    content: content,
                  });
                },
              },
              {
                ...
                value: function sendCommand(command) {
                  ...
                  self._sendPostMessage({
                    code: _Constants2.default.SEND_COMMAND_CODE,
                    command: command,
                  });
                },
              },
...
*/
              ...
              value: function processLocalStorageExpires() {
                try {
                  ...
                  for (var i = 0, j = window.localStorage.length; i < j; i++) {
                    try {
                      var currentValue = window.localStorage.getItem(
                      ...
                      if (
                        ...
                        currentValue.expires <= currentDate
                      ) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        $export(
          $export.P + $export.F * __webpack_require__(79)(ENDS_WITH),
          "String",
          {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        $export(
          $export.P + $export.F * __webpack_require__(79)(INCLUDES),
          "String",
          {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        $export(
          $export.P + $export.F * __webpack_require__(79)(STARTS_WITH),
          "String",
          {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        $export(
          $export.P +
            $export.F * !__webpack_require__(20)([].reduceRight, true),
          "Array",
          {
      ...
      /***/ function (module, exports, __webpack_require__) {
        var $export = __webpack_require__(0);
        $export(
          $export.G + $export.W + $export.F * !__webpack_require__(59).ABV,
          {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        __webpack_require__(6) &&
          $export($export.P + __webpack_require__(60), "Object", {
